// /_/src/Flecs.NET/Generated/ObserverBuilder/ObserverBuilder.QueryBuilder/T2.g.cs
...
public unsafe partial struct ObserverBuilder<T0, T1>
{
    ...
    public ref ObserverBuilder<T0, T1> Self()
    {
    ...
    public ref ObserverBuilder<T0, T1> Id(ulong id)
    {
    ...
    public ref ObserverBuilder<T0, T1> Entity(ulong entity)
    {
    ...
    public ref ObserverBuilder<T0, T1> Name(string name)
    {
    ...
    public ref ObserverBuilder<T0, T1> Var(string name)
    {
    ...
    public ref ObserverBuilder<T0, T1> Term(ulong id)
    {
    ...
    public ref ObserverBuilder<T0, T1> Src()
    {
    ...
    public ref ObserverBuilder<T0, T1> First()
    {
    ...
    public ref ObserverBuilder<T0, T1> Second()
    {
    ...
    public ref ObserverBuilder<T0, T1> Src(ulong srcId)
    {
    ...
    public ref ObserverBuilder<T0, T1> Src<T>()
    {
    ...
    public ref ObserverBuilder<T0, T1> Src<T>(T value) where T : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> Src(string name)
    {
    ...
    public ref ObserverBuilder<T0, T1> First(ulong firstId)
    {
    ...
    public ref ObserverBuilder<T0, T1> First<T>()
    {
    ...
    public ref ObserverBuilder<T0, T1> First<T>(T value) where T : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> First(string name)
    {
    ...
    public ref ObserverBuilder<T0, T1> Second(ulong secondId)
    {
    ...
    public ref ObserverBuilder<T0, T1> Second<T>()
    {
    ...
    public ref ObserverBuilder<T0, T1> Second<T>(T value) where T : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> Second(string secondName)
    {
    ...
    public ref ObserverBuilder<T0, T1> Up(ulong traverse = 0)
    {
    ...
    public ref ObserverBuilder<T0, T1> Up<T>()
    {
    ...
    public ref ObserverBuilder<T0, T1> Up<T>(T value) where T : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> Cascade(ulong traverse = 0)
    {
    ...
    public ref ObserverBuilder<T0, T1> Cascade<T>()
    {
    ...
    public ref ObserverBuilder<T0, T1> Cascade<T>(T value) where T : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> Descend()
    {
    ...
    public ref ObserverBuilder<T0, T1> Parent()
    {
    ...
    public ref ObserverBuilder<T0, T1> Trav(ulong traverse, uint flags = 0)
    {
    ...
    public ref ObserverBuilder<T0, T1> Trav<T>(uint flags = 0)
    {
    ...
    public ref ObserverBuilder<T0, T1> Trav<T>(T value, uint flags = 0) where T : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> Flags(ulong flags)
    {
    ...
    public ref ObserverBuilder<T0, T1> InOut(ecs_inout_kind_t inOut)
    {
    ...
    public ref ObserverBuilder<T0, T1> InOutStage(ecs_inout_kind_t inOut)
    {
    ...
    public ref ObserverBuilder<T0, T1> Write()
    {
    ...
    public ref ObserverBuilder<T0, T1> Read()
    {
    ...
    public ref ObserverBuilder<T0, T1> ReadWrite()
    {
    ...
    public ref ObserverBuilder<T0, T1> In()
    {
    ...
    public ref ObserverBuilder<T0, T1> Out()
    {
    ...
    public ref ObserverBuilder<T0, T1> InOut()
    {
    ...
    public ref ObserverBuilder<T0, T1> InOutNone()
    {
    ...
    public ref ObserverBuilder<T0, T1> Oper(ecs_oper_kind_t oper)
    {
    ...
    public ref ObserverBuilder<T0, T1> And()
    {
    ...
    public ref ObserverBuilder<T0, T1> Or()
    {
    ...
    public ref ObserverBuilder<T0, T1> Not()
    {
    ...
    public ref ObserverBuilder<T0, T1> Optional()
    {
    ...
    public ref ObserverBuilder<T0, T1> AndFrom()
    {
    ...
    public ref ObserverBuilder<T0, T1> OrFrom()
    {
    ...
    public ref ObserverBuilder<T0, T1> NotFrom()
    {
    ...
    public ref ObserverBuilder<T0, T1> Singleton()
    {
    ...
    public ref ObserverBuilder<T0, T1> Filter()
    {
    ...
    public ref ObserverBuilder<T0, T1> QueryFlags(uint flags)
    {
    ...
    public ref ObserverBuilder<T0, T1> CacheKind(ecs_query_cache_kind_t kind)
    {
    ...
    public ref ObserverBuilder<T0, T1> Cached()
    {
    ...
    public ref ObserverBuilder<T0, T1> With(Term term)
    {
    ...
    public ref ObserverBuilder<T0, T1> With(ulong id)
    {
    ...
    public ref ObserverBuilder<T0, T1> With(string name)
    {
    ...
    public ref ObserverBuilder<T0, T1> With(ulong first, ulong second)
    {
    ...
    public ref ObserverBuilder<T0, T1> With(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> With(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> With(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> With<T>()
    {
    ...
    public ref ObserverBuilder<T0, T1> With<T>(T value) where T : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> With<TFirst>(ulong second)
    {
    ...
    public ref ObserverBuilder<T0, T1> With<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).With<TFirst>(second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> With<TFirst, TSecond>()
    {
    ...
    public ref ObserverBuilder<T0, T1> With<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> With<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> With<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> With<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> WithSecond<TSecond>(ulong first)
    {
    ...
    public ref ObserverBuilder<T0, T1> WithSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WithSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Without(Term term)
    {
    ...
    public ref ObserverBuilder<T0, T1> Without(ulong id)
    {
    ...
    public ref ObserverBuilder<T0, T1> Without(string name)
    {
    ...
    public ref ObserverBuilder<T0, T1> Without(ulong first, ulong second)
    {
    ...
    public ref ObserverBuilder<T0, T1> Without(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Without(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Without(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Without<T>()
    {
    ...
    public ref ObserverBuilder<T0, T1> Without<T>(T value) where T : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> Without<TFirst>(ulong second)
    {
    ...
    public ref ObserverBuilder<T0, T1> Without<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Without<TFirst>(second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Without<TFirst, TSecond>()
    {
    ...
    public ref ObserverBuilder<T0, T1> Without<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> Without<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> Without<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Without<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> WithoutSecond<TSecond>(ulong first)
    {
    ...
    public ref ObserverBuilder<T0, T1> WithoutSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WithoutSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Write(Term term)
    {
    ...
    public ref ObserverBuilder<T0, T1> Write(ulong id)
    {
    ...
    public ref ObserverBuilder<T0, T1> Write(string name)
    {
    ...
    public ref ObserverBuilder<T0, T1> Write(ulong first, ulong second)
    {
    ...
    public ref ObserverBuilder<T0, T1> Write(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Write(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Write(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Write<T>()
    {
    ...
    public ref ObserverBuilder<T0, T1> Write<T>(T value) where T : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> Write<TFirst>(ulong second)
    {
    ...
    public ref ObserverBuilder<T0, T1> Write<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Write<TFirst>(second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Write<TFirst, TSecond>()
    {
    ...
    public ref ObserverBuilder<T0, T1> Write<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> Write<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> Write<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Write<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> WriteSecond<TSecond>(ulong first)
    {
    ...
    public ref ObserverBuilder<T0, T1> WriteSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WriteSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Read(Term term)
    {
    ...
    public ref ObserverBuilder<T0, T1> Read(ulong id)
    {
    ...
    public ref ObserverBuilder<T0, T1> Read(string name)
    {
    ...
    public ref ObserverBuilder<T0, T1> Read(ulong first, ulong second)
    {
    ...
    public ref ObserverBuilder<T0, T1> Read(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Read(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Read(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Read<T>()
    {
    ...
    public ref ObserverBuilder<T0, T1> Read<T>(T value) where T : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> Read<TFirst>(ulong second)
    {
    ...
    public ref ObserverBuilder<T0, T1> Read<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Read<TFirst>(second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Read<TFirst, TSecond>()
    {
    ...
    public ref ObserverBuilder<T0, T1> Read<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> Read<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref ObserverBuilder<T0, T1> Read<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> Read<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> ReadSecond<TSecond>(ulong first)
    {
    ...
    public ref ObserverBuilder<T0, T1> ReadSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).ReadSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> ScopeOpen()
    {
    ...
    public ref ObserverBuilder<T0, T1> ScopeClose()
    {
    ...
    public ref ObserverBuilder<T0, T1> Term()
    {
    ...
    public ref ObserverBuilder<T0, T1> TermAt<T>()
    {
    ...
    public ref ObserverBuilder<T0, T1> TermAt(int termIndex)
    {
    ...
    public ref ObserverBuilder<T0, T1> TermAt<T>(int termIndex)
    {
    ...
    public ref ObserverBuilder<T0, T1> OrderBy(ulong component, Ecs.OrderByCallback callback)
    {
    ...
    public ref ObserverBuilder<T0, T1> OrderBy<T>(Ecs.OrderByCallback callback)
    {
    ...
    public ref ObserverBuilder<T0, T1> GroupBy(ulong component)
    {
    ...
    public ref ObserverBuilder<T0, T1> GroupBy(ulong component, Ecs.GroupByCallback callback)
    {
    ...
    public ref ObserverBuilder<T0, T1> GroupBy<TContext>(ulong component, Ecs.GroupByCallback<TContext> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupBy(component, callback);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> GroupBy<T>()
    {
    ...
    public ref ObserverBuilder<T0, T1> GroupBy<T>(Ecs.GroupByCallback callback)
    {
    ...
    public ref ObserverBuilder<T0, T1> GroupBy<T, TContext>(Ecs.GroupByCallback<TContext> callback)
    {
    ...
    public ref ObserverBuilder<T0, T1> GroupByCtx<T>(T value)
    {
    ...
    public ref ObserverBuilder<T0, T1> GroupByCtx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="Core.QueryBuilder.GroupByCtx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref ObserverBuilder<T0, T1> GroupByCtx<T>(T value, delegate*<ref T, void> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupByCtx(value, callback);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> OnGroupCreate(Ecs.GroupCreateCallback callback)
    {
    ...
    public ref ObserverBuilder<T0, T1> OnGroupCreate<T>(Ecs.GroupCreateCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupCreate(callback);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1> OnGroupDelete(Ecs.GroupDeleteCallback callback)
    {
    ...
    public ref ObserverBuilder<T0, T1> OnGroupDelete<T>(Ecs.GroupDeleteCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupDelete(callback);
        return ref this;
    }
