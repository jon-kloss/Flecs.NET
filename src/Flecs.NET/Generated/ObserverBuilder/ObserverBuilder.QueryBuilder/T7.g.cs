// /_/src/Flecs.NET/Generated/ObserverBuilder/ObserverBuilder.QueryBuilder/T7.g.cs
...
public unsafe partial struct ObserverBuilder<T0, T1, T2, T3, T4, T5, T6>
{
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> DetectChanges()
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> TermAt<T>()
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> TermAt<T>(int termIndex)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> OrderBy(ulong component, Ecs.OrderByCallback callback)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> OrderBy<T>(Ecs.OrderByCallback callback)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> GroupBy<TContext>(ulong component, Ecs.GroupByCallback<TContext> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupBy(component, callback);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> GroupBy<T, TContext>(Ecs.GroupByCallback<TContext> callback)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> GroupByCtx<T>(T value)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> GroupByCtx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="Core.QueryBuilder.GroupByCtx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> GroupByCtx<T>(T value, delegate*<ref T, void> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupByCtx(value, callback);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> OnGroupCreate(Ecs.GroupCreateCallback callback)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> OnGroupCreate<T>(Ecs.GroupCreateCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupCreate(callback);
        return ref this;
    }
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> OnGroupDelete(Ecs.GroupDeleteCallback callback)
    {
    ...
    public ref ObserverBuilder<T0, T1, T2, T3, T4, T5, T6> OnGroupDelete<T>(Ecs.GroupDeleteCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupDelete(callback);
        return ref this;
    }
