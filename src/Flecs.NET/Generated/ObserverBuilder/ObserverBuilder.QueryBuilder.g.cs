// /_/src/Flecs.NET/Generated/ObserverBuilder/ObserverBuilder.QueryBuilder.g.cs
...
public unsafe partial struct ObserverBuilder
{
    ...
    public ref ObserverBuilder Flags(ulong flags)
    {
    ...
    public ref ObserverBuilder DetectChanges()
    {
    ...
    public ref ObserverBuilder TermAt<T>()
    {
    ...
    public ref ObserverBuilder TermAt<T>(int termIndex)
    {
    ...
    public ref ObserverBuilder OrderBy(ulong component, Ecs.OrderByCallback callback)
    {
    ...
    public ref ObserverBuilder OrderBy<T>(Ecs.OrderByCallback callback)
    {
    ...
    public ref ObserverBuilder GroupBy<TContext>(ulong component, Ecs.GroupByCallback<TContext> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupBy(component, callback);
        return ref this;
    }
    ...
    public ref ObserverBuilder GroupBy<T, TContext>(Ecs.GroupByCallback<TContext> callback)
    {
    ...
    public ref ObserverBuilder GroupByCtx<T>(T value)
    {
    ...
    public ref ObserverBuilder GroupByCtx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="Core.QueryBuilder.GroupByCtx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref ObserverBuilder GroupByCtx<T>(T value, delegate*<ref T, void> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupByCtx(value, callback);
        return ref this;
    }
    ...
    public ref ObserverBuilder OnGroupCreate(Ecs.GroupCreateCallback callback)
    {
    ...
    public ref ObserverBuilder OnGroupCreate<T>(Ecs.GroupCreateCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupCreate(callback);
        return ref this;
    }
    ...
    public ref ObserverBuilder OnGroupDelete(Ecs.GroupDeleteCallback callback)
    {
    ...
    public ref ObserverBuilder OnGroupDelete<T>(Ecs.GroupDeleteCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupDelete(callback);
        return ref this;
    }
