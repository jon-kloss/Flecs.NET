// /_/src/Flecs.NET/Generated/SystemBuilder/SystemBuilder.QueryBuilder/T3.g.cs
...
public unsafe partial struct SystemBuilder<T0, T1, T2>
{
    ...
    public ref SystemBuilder<T0, T1, T2> Self()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Id(ulong id)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Entity(ulong entity)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Name(string name)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Var(string name)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Term(ulong id)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Src()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> First()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Second()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Src(ulong srcId)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Src<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Src<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Src(string name)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> First(ulong firstId)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> First<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> First<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> First(string name)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Second(ulong secondId)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Second<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Second<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Second(string secondName)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Up(ulong traverse = 0)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Up<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Up<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Cascade(ulong traverse = 0)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Cascade<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Cascade<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Descend()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Parent()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Trav(ulong traverse, uint flags = 0)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Trav<T>(uint flags = 0)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Trav<T>(T value, uint flags = 0) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Flags(ulong flags)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> InOut(ecs_inout_kind_t inOut)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> InOutStage(ecs_inout_kind_t inOut)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Write()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Read()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> ReadWrite()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> In()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Out()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> InOut()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> InOutNone()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Oper(ecs_oper_kind_t oper)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> And()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Or()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Not()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Optional()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> AndFrom()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> OrFrom()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> NotFrom()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Singleton()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Filter()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> QueryFlags(uint flags)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> CacheKind(ecs_query_cache_kind_t kind)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Cached()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> DetectChanges()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Expr(string expr)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> With(Term term)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> With(ulong id)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> With(string name)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> With(ulong first, ulong second)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> With(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> With(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> With(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> With<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> With<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> With<TFirst>(ulong second)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> With<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).With<TFirst>(second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> With<TFirst, TSecond>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> With<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> With<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> With<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> With<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> WithSecond<TSecond>(ulong first)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> WithSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WithSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Without(Term term)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Without(ulong id)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Without(string name)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Without(ulong first, ulong second)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Without(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Without(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Without(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Without<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Without<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Without<TFirst>(ulong second)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Without<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Without<TFirst>(second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Without<TFirst, TSecond>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Without<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Without<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Without<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Without<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> WithoutSecond<TSecond>(ulong first)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> WithoutSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WithoutSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Write(Term term)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Write(ulong id)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Write(string name)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Write(ulong first, ulong second)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Write(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Write(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Write(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Write<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Write<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Write<TFirst>(ulong second)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Write<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Write<TFirst>(second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Write<TFirst, TSecond>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Write<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Write<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Write<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Write<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> WriteSecond<TSecond>(ulong first)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> WriteSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WriteSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Read(Term term)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Read(ulong id)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Read(string name)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Read(ulong first, ulong second)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Read(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Read(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Read(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Read<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Read<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Read<TFirst>(ulong second)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Read<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Read<TFirst>(second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Read<TFirst, TSecond>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Read<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Read<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Read<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> Read<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> ReadSecond<TSecond>(ulong first)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> ReadSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).ReadSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> ScopeOpen()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> ScopeClose()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> Term()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> TermAt<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> TermAt(int termIndex)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> TermAt<T>(int termIndex)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> OrderBy(ulong component, Ecs.OrderByCallback callback)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> OrderBy<T>(Ecs.OrderByCallback callback)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> GroupBy(ulong component)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> GroupBy(ulong component, Ecs.GroupByCallback callback)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> GroupBy<TContext>(ulong component, Ecs.GroupByCallback<TContext> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupBy(component, callback);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> GroupBy<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2> GroupBy<T>(Ecs.GroupByCallback callback)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> GroupBy<T, TContext>(Ecs.GroupByCallback<TContext> callback)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> GroupByCtx<T>(T value)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> GroupByCtx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="Core.QueryBuilder.GroupByCtx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref SystemBuilder<T0, T1, T2> GroupByCtx<T>(T value, delegate*<ref T, void> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupByCtx(value, callback);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> OnGroupCreate(Ecs.GroupCreateCallback callback)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> OnGroupCreate<T>(Ecs.GroupCreateCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupCreate(callback);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2> OnGroupDelete(Ecs.GroupDeleteCallback callback)
    {
    ...
    public ref SystemBuilder<T0, T1, T2> OnGroupDelete<T>(Ecs.GroupDeleteCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupDelete(callback);
        return ref this;
    }
