// /_/src/Flecs.NET/Generated/SystemBuilder/SystemBuilder.QueryBuilder/T5.g.cs
...
public unsafe partial struct SystemBuilder<T0, T1, T2, T3, T4>
{
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Self()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Id(ulong id)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Entity(ulong entity)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Name(string name)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Var(string name)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Term(ulong id)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Src()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> First()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Second()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Src(ulong srcId)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Src<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Src<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Src(string name)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> First(ulong firstId)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> First<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> First<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> First(string name)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Second(ulong secondId)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Second<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Second<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Second(string secondName)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Up(ulong traverse = 0)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Up<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Up<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Cascade(ulong traverse = 0)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Cascade<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Cascade<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Descend()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Parent()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Trav(ulong traverse, uint flags = 0)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Trav<T>(uint flags = 0)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Trav<T>(T value, uint flags = 0) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Flags(ulong flags)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> InOut(ecs_inout_kind_t inOut)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> InOutStage(ecs_inout_kind_t inOut)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Write()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Read()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> ReadWrite()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> In()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Out()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> InOut()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> InOutNone()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Oper(ecs_oper_kind_t oper)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> And()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Or()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Not()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Optional()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> AndFrom()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> OrFrom()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> NotFrom()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Singleton()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Filter()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> QueryFlags(uint flags)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> CacheKind(ecs_query_cache_kind_t kind)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Cached()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> DetectChanges()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Expr(string expr)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> With(Term term)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> With(ulong id)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> With(string name)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> With(ulong first, ulong second)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> With(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> With(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> With(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> With<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> With<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> With<TFirst>(ulong second)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> With<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).With<TFirst>(second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> With<TFirst, TSecond>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> With<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> With<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> With<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> With<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> WithSecond<TSecond>(ulong first)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> WithSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WithSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Without(Term term)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Without(ulong id)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Without(string name)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Without(ulong first, ulong second)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Without(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Without(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Without(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Without<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Without<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Without<TFirst>(ulong second)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Without<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Without<TFirst>(second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Without<TFirst, TSecond>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Without<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Without<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Without<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Without<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> WithoutSecond<TSecond>(ulong first)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> WithoutSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WithoutSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Write(Term term)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Write(ulong id)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Write(string name)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Write(ulong first, ulong second)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Write(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Write(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Write(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Write<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Write<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Write<TFirst>(ulong second)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Write<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Write<TFirst>(second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Write<TFirst, TSecond>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Write<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Write<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Write<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Write<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> WriteSecond<TSecond>(ulong first)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> WriteSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WriteSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Read(Term term)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Read(ulong id)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Read(string name)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Read(ulong first, ulong second)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Read(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Read(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Read(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Read<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Read<T>(T value) where T : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Read<TFirst>(ulong second)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Read<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Read<TFirst>(second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Read<TFirst, TSecond>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Read<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Read<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Read<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Read<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> ReadSecond<TSecond>(ulong first)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> ReadSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).ReadSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> ScopeOpen()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> ScopeClose()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> Term()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> TermAt<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> TermAt(int termIndex)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> TermAt<T>(int termIndex)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> OrderBy(ulong component, Ecs.OrderByCallback callback)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> OrderBy<T>(Ecs.OrderByCallback callback)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> GroupBy(ulong component)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> GroupBy(ulong component, Ecs.GroupByCallback callback)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> GroupBy<TContext>(ulong component, Ecs.GroupByCallback<TContext> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupBy(component, callback);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> GroupBy<T>()
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> GroupBy<T>(Ecs.GroupByCallback callback)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> GroupBy<T, TContext>(Ecs.GroupByCallback<TContext> callback)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> GroupByCtx<T>(T value)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> GroupByCtx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="Core.QueryBuilder.GroupByCtx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref SystemBuilder<T0, T1, T2, T3, T4> GroupByCtx<T>(T value, delegate*<ref T, void> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupByCtx(value, callback);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> OnGroupCreate(Ecs.GroupCreateCallback callback)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> OnGroupCreate<T>(Ecs.GroupCreateCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupCreate(callback);
        return ref this;
    }
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> OnGroupDelete(Ecs.GroupDeleteCallback callback)
    {
    ...
    public ref SystemBuilder<T0, T1, T2, T3, T4> OnGroupDelete<T>(Ecs.GroupDeleteCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupDelete(callback);
        return ref this;
    }
