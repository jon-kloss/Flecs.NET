...
public static unsafe partial class Ecs
{
    ...
    {
        ptrs[0] = ecs_ensure_id(world, e, Type<T0>.Id(world), (nint)Type<T0>.Size); ptrs[1] = ecs_ensure_id(world, e, Type<T1>.Id(world), (nint)Type<T1>.Size); ptrs[2] = ecs_ensure_id(world, e, Type<T2>.Id(world), (nint)Type<T2>.Size); ptrs[3] = ecs_ensure_id(world, e, Type<T3>.Id(world), (nint)Type<T3>.Size); ptrs[4] = ecs_ensure_id(world, e, Type<T4>.Id(world), (nint)Type<T4>.Size); ptrs[5] = ecs_ensure_id(world, e, Type<T5>.Id(world), (nint)Type<T5>.Size); ptrs[6] = ecs_ensure_id(world, e, Type<T6>.Id(world), (nint)Type<T6>.Size); ptrs[7] = ecs_ensure_id(world, e, Type<T7>.Id(world), (nint)Type<T7>.Size); ptrs[8] = ecs_ensure_id(world, e, Type<T8>.Id(world), (nint)Type<T8>.Size); ptrs[9] = ecs_ensure_id(world, e, Type<T9>.Id(world), (nint)Type<T9>.Size); ptrs[10] = ecs_ensure_id(world, e, Type<T10>.Id(world), (nint)Type<T10>.Size); ptrs[11] = ecs_ensure_id(world, e, Type<T11>.Id(world), (nint)Type<T11>.Size); ptrs[12] = ecs_ensure_id(world, e, Type<T12>.Id(world), (nint)Type<T12>.Size); ptrs[13] = ecs_ensure_id(world, e, Type<T13>.Id(world), (nint)Type<T13>.Size);
        return true;
    }
