// /_/src/Flecs.NET/Generated/PipelineBuilder/PipelineBuilder.QueryBuilder/T4.g.cs
...
public unsafe partial struct PipelineBuilder<T0, T1, T2, T3>
{
    ...
    public ref PipelineBuilder<T0, T1, T2, T3> DetectChanges()
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3> TermAt<T>()
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3> TermAt<T>(int termIndex)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3> OrderBy(ulong component, Ecs.OrderByCallback callback)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3> OrderBy<T>(Ecs.OrderByCallback callback)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3> GroupBy<TContext>(ulong component, Ecs.GroupByCallback<TContext> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupBy(component, callback);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0, T1, T2, T3> GroupBy<T, TContext>(Ecs.GroupByCallback<TContext> callback)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3> GroupByCtx<T>(T value)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3> GroupByCtx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="Core.QueryBuilder.GroupByCtx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref PipelineBuilder<T0, T1, T2, T3> GroupByCtx<T>(T value, delegate*<ref T, void> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupByCtx(value, callback);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0, T1, T2, T3> OnGroupCreate(Ecs.GroupCreateCallback callback)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3> OnGroupCreate<T>(Ecs.GroupCreateCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupCreate(callback);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0, T1, T2, T3> OnGroupDelete(Ecs.GroupDeleteCallback callback)
    {
    ...
    public ref PipelineBuilder<T0, T1, T2, T3> OnGroupDelete<T>(Ecs.GroupDeleteCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupDelete(callback);
        return ref this;
    }
