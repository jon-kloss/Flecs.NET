// /_/src/Flecs.NET/Generated/PipelineBuilder/PipelineBuilder.QueryBuilder/T1.g.cs
...
public unsafe partial struct PipelineBuilder<T0>
{
    /// <inheritdoc cref="Core.QueryBuilder.Self()"/>
    public ref PipelineBuilder<T0> Self()
    {
    ...
    public ref PipelineBuilder<T0> Id(ulong id)
    {
    ...
    public ref PipelineBuilder<T0> Entity(ulong entity)
    {
    ...
    public ref PipelineBuilder<T0> Name(string name)
    {
    ...
    public ref PipelineBuilder<T0> Var(string name)
    {
    ...
    public ref PipelineBuilder<T0> Term(ulong id)
    {
    ...
    public ref PipelineBuilder<T0> Src()
    {
    ...
    public ref PipelineBuilder<T0> First()
    {
    ...
    public ref PipelineBuilder<T0> Second()
    {
    ...
    public ref PipelineBuilder<T0> Src(ulong srcId)
    {
    ...
    public ref PipelineBuilder<T0> Src<T>()
    {
    ...
    public ref PipelineBuilder<T0> Src<T>(T value) where T : Enum
    {
    ...
    public ref PipelineBuilder<T0> Src(string name)
    {
    ...
    public ref PipelineBuilder<T0> First(ulong firstId)
    {
    ...
    public ref PipelineBuilder<T0> First<T>()
    {
    ...
    public ref PipelineBuilder<T0> First<T>(T value) where T : Enum
    {
    ...
    public ref PipelineBuilder<T0> First(string name)
    {
    ...
    public ref PipelineBuilder<T0> Second(ulong secondId)
    {
    ...
    public ref PipelineBuilder<T0> Second<T>()
    {
    ...
    public ref PipelineBuilder<T0> Second<T>(T value) where T : Enum
    {
    ...
    public ref PipelineBuilder<T0> Second(string secondName)
    {
    ...
    public ref PipelineBuilder<T0> Up(ulong traverse = 0)
    {
    ...
    public ref PipelineBuilder<T0> Up<T>()
    {
    ...
    public ref PipelineBuilder<T0> Up<T>(T value) where T : Enum
    {
    ...
    public ref PipelineBuilder<T0> Cascade(ulong traverse = 0)
    {
    ...
    public ref PipelineBuilder<T0> Cascade<T>()
    {
    ...
    public ref PipelineBuilder<T0> Cascade<T>(T value) where T : Enum
    {
    ...
    public ref PipelineBuilder<T0> Descend()
    {
    ...
    public ref PipelineBuilder<T0> Parent()
    {
    ...
    public ref PipelineBuilder<T0> Trav(ulong traverse, uint flags = 0)
    {
    ...
    public ref PipelineBuilder<T0> Trav<T>(uint flags = 0)
    {
    ...
    public ref PipelineBuilder<T0> Trav<T>(T value, uint flags = 0) where T : Enum
    {
    ...
    public ref PipelineBuilder<T0> Flags(ulong flags)
    {
    ...
    public ref PipelineBuilder<T0> InOut(ecs_inout_kind_t inOut)
    {
    ...
    public ref PipelineBuilder<T0> InOutStage(ecs_inout_kind_t inOut)
    {
    ...
    public ref PipelineBuilder<T0> Write()
    {
    ...
    public ref PipelineBuilder<T0> Read()
    {
    ...
    public ref PipelineBuilder<T0> ReadWrite()
    {
    ...
    public ref PipelineBuilder<T0> In()
    {
    ...
    public ref PipelineBuilder<T0> Out()
    {
    ...
    public ref PipelineBuilder<T0> InOut()
    {
    ...
    public ref PipelineBuilder<T0> InOutNone()
    {
    ...
    public ref PipelineBuilder<T0> Oper(ecs_oper_kind_t oper)
    {
    ...
    public ref PipelineBuilder<T0> And()
    {
    ...
    public ref PipelineBuilder<T0> Or()
    {
    ...
    public ref PipelineBuilder<T0> Not()
    {
    ...
    public ref PipelineBuilder<T0> Optional()
    {
    ...
    public ref PipelineBuilder<T0> AndFrom()
    {
    ...
    public ref PipelineBuilder<T0> OrFrom()
    {
    ...
    public ref PipelineBuilder<T0> NotFrom()
    {
    ...
    public ref PipelineBuilder<T0> Singleton()
    {
    ...
    public ref PipelineBuilder<T0> Filter()
    {
    ...
    public ref PipelineBuilder<T0> QueryFlags(uint flags)
    {
    ...
    public ref PipelineBuilder<T0> CacheKind(ecs_query_cache_kind_t kind)
    {
    ...
    public ref PipelineBuilder<T0> Cached()
    {
    ...
    public ref PipelineBuilder<T0> DetectChanges()
    {
    ...
    public ref PipelineBuilder<T0> Expr(string expr)
    {
    ...
    public ref PipelineBuilder<T0> With(Term term)
    {
    ...
    public ref PipelineBuilder<T0> With(ulong id)
    {
    ...
    public ref PipelineBuilder<T0> With(string name)
    {
    ...
    public ref PipelineBuilder<T0> With(ulong first, ulong second)
    {
    ...
    public ref PipelineBuilder<T0> With(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> With(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> With(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> With<T>()
    {
    ...
    public ref PipelineBuilder<T0> With<T>(T value) where T : Enum
    {
    ...
    public ref PipelineBuilder<T0> With<TFirst>(ulong second)
    {
    ...
    public ref PipelineBuilder<T0> With<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).With<TFirst>(second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> With<TFirst, TSecond>()
    {
    ...
    public ref PipelineBuilder<T0> With<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref PipelineBuilder<T0> With<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref PipelineBuilder<T0> With<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> With<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> WithSecond<TSecond>(ulong first)
    {
    ...
    public ref PipelineBuilder<T0> WithSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WithSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Without(Term term)
    {
    ...
    public ref PipelineBuilder<T0> Without(ulong id)
    {
    ...
    public ref PipelineBuilder<T0> Without(string name)
    {
    ...
    public ref PipelineBuilder<T0> Without(ulong first, ulong second)
    {
    ...
    public ref PipelineBuilder<T0> Without(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Without(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Without(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Without<T>()
    {
    ...
    public ref PipelineBuilder<T0> Without<T>(T value) where T : Enum
    {
    ...
    public ref PipelineBuilder<T0> Without<TFirst>(ulong second)
    {
    ...
    public ref PipelineBuilder<T0> Without<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Without<TFirst>(second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Without<TFirst, TSecond>()
    {
    ...
    public ref PipelineBuilder<T0> Without<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref PipelineBuilder<T0> Without<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref PipelineBuilder<T0> Without<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Without<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> WithoutSecond<TSecond>(ulong first)
    {
    ...
    public ref PipelineBuilder<T0> WithoutSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WithoutSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Write(Term term)
    {
    ...
    public ref PipelineBuilder<T0> Write(ulong id)
    {
    ...
    public ref PipelineBuilder<T0> Write(string name)
    {
    ...
    public ref PipelineBuilder<T0> Write(ulong first, ulong second)
    {
    ...
    public ref PipelineBuilder<T0> Write(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Write(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Write(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Write<T>()
    {
    ...
    public ref PipelineBuilder<T0> Write<T>(T value) where T : Enum
    {
    ...
    public ref PipelineBuilder<T0> Write<TFirst>(ulong second)
    {
    ...
    public ref PipelineBuilder<T0> Write<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Write<TFirst>(second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Write<TFirst, TSecond>()
    {
    ...
    public ref PipelineBuilder<T0> Write<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref PipelineBuilder<T0> Write<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref PipelineBuilder<T0> Write<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Write<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> WriteSecond<TSecond>(ulong first)
    {
    ...
    public ref PipelineBuilder<T0> WriteSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WriteSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Read(Term term)
    {
    ...
    public ref PipelineBuilder<T0> Read(ulong id)
    {
    ...
    public ref PipelineBuilder<T0> Read(string name)
    {
    ...
    public ref PipelineBuilder<T0> Read(ulong first, ulong second)
    {
    ...
    public ref PipelineBuilder<T0> Read(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Read(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Read(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Read<T>()
    {
    ...
    public ref PipelineBuilder<T0> Read<T>(T value) where T : Enum
    {
    ...
    public ref PipelineBuilder<T0> Read<TFirst>(ulong second)
    {
    ...
    public ref PipelineBuilder<T0> Read<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Read<TFirst>(second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Read<TFirst, TSecond>()
    {
    ...
    public ref PipelineBuilder<T0> Read<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref PipelineBuilder<T0> Read<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref PipelineBuilder<T0> Read<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> Read<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> ReadSecond<TSecond>(ulong first)
    {
    ...
    public ref PipelineBuilder<T0> ReadSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).ReadSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> ScopeOpen()
    {
    ...
    public ref PipelineBuilder<T0> ScopeClose()
    {
    ...
    public ref PipelineBuilder<T0> Term()
    {
    ...
    public ref PipelineBuilder<T0> TermAt<T>()
    {
    ...
    public ref PipelineBuilder<T0> TermAt(int termIndex)
    {
    ...
    public ref PipelineBuilder<T0> TermAt<T>(int termIndex)
    {
    ...
    public ref PipelineBuilder<T0> OrderBy(ulong component, Ecs.OrderByCallback callback)
    {
    ...
    public ref PipelineBuilder<T0> OrderBy<T>(Ecs.OrderByCallback callback)
    {
    ...
    public ref PipelineBuilder<T0> GroupBy(ulong component)
    {
    ...
    public ref PipelineBuilder<T0> GroupBy(ulong component, Ecs.GroupByCallback callback)
    {
    ...
    public ref PipelineBuilder<T0> GroupBy<TContext>(ulong component, Ecs.GroupByCallback<TContext> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupBy(component, callback);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> GroupBy<T>()
    {
    ...
    public ref PipelineBuilder<T0> GroupBy<T>(Ecs.GroupByCallback callback)
    {
    ...
    public ref PipelineBuilder<T0> GroupBy<T, TContext>(Ecs.GroupByCallback<TContext> callback)
    {
    ...
    public ref PipelineBuilder<T0> GroupByCtx<T>(T value)
    {
    ...
    public ref PipelineBuilder<T0> GroupByCtx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="Core.QueryBuilder.GroupByCtx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref PipelineBuilder<T0> GroupByCtx<T>(T value, delegate*<ref T, void> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupByCtx(value, callback);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> OnGroupCreate(Ecs.GroupCreateCallback callback)
    {
    ...
    public ref PipelineBuilder<T0> OnGroupCreate<T>(Ecs.GroupCreateCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupCreate(callback);
        return ref this;
    }
    ...
    public ref PipelineBuilder<T0> OnGroupDelete(Ecs.GroupDeleteCallback callback)
    {
    ...
    public ref PipelineBuilder<T0> OnGroupDelete<T>(Ecs.GroupDeleteCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupDelete(callback);
        return ref this;
    }
