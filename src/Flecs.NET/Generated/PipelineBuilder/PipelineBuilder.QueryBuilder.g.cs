// /_/src/Flecs.NET/Generated/PipelineBuilder/PipelineBuilder.QueryBuilder.g.cs
...
public unsafe partial struct PipelineBuilder
{
    ...
    public ref PipelineBuilder DetectChanges()
    {
    ...
    public ref PipelineBuilder TermAt<T>()
    {
    ...
    public ref PipelineBuilder TermAt<T>(int termIndex)
    {
    ...
    public ref PipelineBuilder OrderBy(ulong component, Ecs.OrderByCallback callback)
    {
    ...
    public ref PipelineBuilder OrderBy<T>(Ecs.OrderByCallback callback)
    {
    ...
    public ref PipelineBuilder GroupBy<TContext>(ulong component, Ecs.GroupByCallback<TContext> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupBy(component, callback);
        return ref this;
    }
    ...
    public ref PipelineBuilder GroupBy<T, TContext>(Ecs.GroupByCallback<TContext> callback)
    {
    ...
    public ref PipelineBuilder GroupByCtx<T>(T value)
    {
    ...
    public ref PipelineBuilder GroupByCtx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="Core.QueryBuilder.GroupByCtx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref PipelineBuilder GroupByCtx<T>(T value, delegate*<ref T, void> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupByCtx(value, callback);
        return ref this;
    }
    ...
    public ref PipelineBuilder OnGroupCreate(Ecs.GroupCreateCallback callback)
    {
    ...
    public ref PipelineBuilder OnGroupCreate<T>(Ecs.GroupCreateCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupCreate(callback);
        return ref this;
    }
    ...
    public ref PipelineBuilder OnGroupDelete(Ecs.GroupDeleteCallback callback)
    {
    ...
    public ref PipelineBuilder OnGroupDelete<T>(Ecs.GroupDeleteCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupDelete(callback);
        return ref this;
    }
