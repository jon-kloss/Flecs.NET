// /_/src/Flecs.NET/Generated/QueryBuilder/QueryBuilder.QueryBuilder/T4.g.cs
...
public unsafe partial struct QueryBuilder<T0, T1, T2, T3>
{
    /// <inheritdoc cref="Core.QueryBuilder.Self()"/>
    public ref QueryBuilder<T0, T1, T2, T3> Self()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Id(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Entity(ulong entity)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Name(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Var(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Term(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Src()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> First()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Second()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Src(ulong srcId)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Src<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Src<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Src(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> First(ulong firstId)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> First<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> First<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> First(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Second(ulong secondId)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Second<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Second<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Second(string secondName)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Up(ulong traverse = 0)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Up<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Up<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Cascade(ulong traverse = 0)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Cascade<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Cascade<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Descend()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Parent()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Trav(ulong traverse, uint flags = 0)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Trav<T>(uint flags = 0)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Trav<T>(T value, uint flags = 0) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Flags(ulong flags)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> InOut(ecs_inout_kind_t inOut)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> InOutStage(ecs_inout_kind_t inOut)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Write()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Read()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> ReadWrite()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> In()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Out()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> InOut()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> InOutNone()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Oper(ecs_oper_kind_t oper)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> And()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Or()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Not()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Optional()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> AndFrom()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> OrFrom()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> NotFrom()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Singleton()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Filter()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> QueryFlags(uint flags)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> CacheKind(ecs_query_cache_kind_t kind)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Cached()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> DetectChanges()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Expr(string expr)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> With(Term term)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> With(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> With(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> With(ulong first, ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> With(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> With(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> With(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> With<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> With<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> With<TFirst>(ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> With<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).With<TFirst>(second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> With<TFirst, TSecond>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> With<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> With<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> With<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> With<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> WithSecond<TSecond>(ulong first)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> WithSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WithSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Without(Term term)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Without(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Without(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Without(ulong first, ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Without(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Without(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Without(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Without<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Without<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Without<TFirst>(ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Without<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Without<TFirst>(second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Without<TFirst, TSecond>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Without<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Without<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Without<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Without<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> WithoutSecond<TSecond>(ulong first)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> WithoutSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WithoutSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Write(Term term)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Write(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Write(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Write(ulong first, ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Write(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Write(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Write(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Write<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Write<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Write<TFirst>(ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Write<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Write<TFirst>(second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Write<TFirst, TSecond>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Write<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Write<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Write<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Write<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> WriteSecond<TSecond>(ulong first)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> WriteSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WriteSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Read(Term term)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Read(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Read(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Read(ulong first, ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Read(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Read(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Read(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Read<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Read<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Read<TFirst>(ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Read<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Read<TFirst>(second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Read<TFirst, TSecond>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Read<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Read<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Read<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Read<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> ReadSecond<TSecond>(ulong first)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> ReadSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).ReadSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> ScopeOpen()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> ScopeClose()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> Term()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> TermAt<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> TermAt(int termIndex)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> TermAt<T>(int termIndex)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> OrderBy(ulong component, Ecs.OrderByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> OrderBy<T>(Ecs.OrderByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> GroupBy(ulong component)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> GroupBy(ulong component, Ecs.GroupByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> GroupBy<TContext>(ulong component, Ecs.GroupByCallback<TContext> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupBy(component, callback);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> GroupBy<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> GroupBy<T>(Ecs.GroupByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> GroupBy<T, TContext>(Ecs.GroupByCallback<TContext> callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> GroupByCtx<T>(T value)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> GroupByCtx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="Core.QueryBuilder.GroupByCtx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref QueryBuilder<T0, T1, T2, T3> GroupByCtx<T>(T value, delegate*<ref T, void> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupByCtx(value, callback);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> OnGroupCreate(Ecs.GroupCreateCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> OnGroupCreate<T>(Ecs.GroupCreateCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupCreate(callback);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3> OnGroupDelete(Ecs.GroupDeleteCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3> OnGroupDelete<T>(Ecs.GroupDeleteCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupDelete(callback);
        return ref this;
    }
