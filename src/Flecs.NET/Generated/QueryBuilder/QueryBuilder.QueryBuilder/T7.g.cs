// /_/src/Flecs.NET/Generated/QueryBuilder/QueryBuilder.QueryBuilder/T7.g.cs
...
public unsafe partial struct QueryBuilder<T0, T1, T2, T3, T4, T5, T6>
{
    /// <inheritdoc cref="Core.QueryBuilder.Self()"/>
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Self()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Id(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Entity(ulong entity)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Name(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Var(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Term(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Src()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> First()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Second()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Src(ulong srcId)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Src<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Src<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Src(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> First(ulong firstId)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> First<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> First<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> First(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Second(ulong secondId)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Second<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Second<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Second(string secondName)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Up(ulong traverse = 0)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Up<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Up<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Cascade(ulong traverse = 0)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Cascade<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Cascade<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Descend()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Parent()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Trav(ulong traverse, uint flags = 0)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Trav<T>(uint flags = 0)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Trav<T>(T value, uint flags = 0) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Flags(ulong flags)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> InOut(ecs_inout_kind_t inOut)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> InOutStage(ecs_inout_kind_t inOut)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Write()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Read()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> ReadWrite()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> In()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Out()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> InOut()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> InOutNone()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Oper(ecs_oper_kind_t oper)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> And()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Or()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Not()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Optional()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> AndFrom()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> OrFrom()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> NotFrom()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Singleton()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Filter()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> QueryFlags(uint flags)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> CacheKind(ecs_query_cache_kind_t kind)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Cached()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> With(Term term)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> With(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> With(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> With(ulong first, ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> With(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> With(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> With(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> With<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> With<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> With<TFirst>(ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> With<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).With<TFirst>(second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> With<TFirst, TSecond>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> With<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> With<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> With<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> With<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> WithSecond<TSecond>(ulong first)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> WithSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WithSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Without(Term term)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Without(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Without(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Without(ulong first, ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Without(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Without(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Without(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Without<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Without<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Without<TFirst>(ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Without<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Without<TFirst>(second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Without<TFirst, TSecond>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Without<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Without<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Without<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Without<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> WithoutSecond<TSecond>(ulong first)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> WithoutSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WithoutSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Write(Term term)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Write(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Write(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Write(ulong first, ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Write(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Write(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Write(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Write<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Write<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Write<TFirst>(ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Write<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Write<TFirst>(second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Write<TFirst, TSecond>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Write<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Write<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Write<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Write<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> WriteSecond<TSecond>(ulong first)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> WriteSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WriteSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Read(Term term)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Read(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Read(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Read(ulong first, ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Read(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Read(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Read(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Read<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Read<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Read<TFirst>(ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Read<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Read<TFirst>(second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Read<TFirst, TSecond>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Read<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Read<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Read<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Read<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> ReadSecond<TSecond>(ulong first)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> ReadSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).ReadSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> ScopeOpen()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> ScopeClose()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> Term()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> TermAt<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> TermAt(int termIndex)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> TermAt<T>(int termIndex)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> OrderBy(ulong component, Ecs.OrderByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> OrderBy<T>(Ecs.OrderByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> GroupBy(ulong component)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> GroupBy(ulong component, Ecs.GroupByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> GroupBy<TContext>(ulong component, Ecs.GroupByCallback<TContext> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupBy(component, callback);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> GroupBy<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> GroupBy<T>(Ecs.GroupByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> GroupBy<T, TContext>(Ecs.GroupByCallback<TContext> callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> GroupByCtx<T>(T value)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> GroupByCtx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="Core.QueryBuilder.GroupByCtx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> GroupByCtx<T>(T value, delegate*<ref T, void> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupByCtx(value, callback);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> OnGroupCreate(Ecs.GroupCreateCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> OnGroupCreate<T>(Ecs.GroupCreateCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupCreate(callback);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> OnGroupDelete(Ecs.GroupDeleteCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6> OnGroupDelete<T>(Ecs.GroupDeleteCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupDelete(callback);
        return ref this;
    }
