// /_/src/Flecs.NET/Generated/QueryBuilder/QueryBuilder.QueryBuilder/T13.g.cs
...
public unsafe partial struct QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>
{
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> DetectChanges()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> TermAt<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> TermAt<T>(int termIndex)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> OrderBy(ulong component, Ecs.OrderByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> OrderBy<T>(Ecs.OrderByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> GroupBy<TContext>(ulong component, Ecs.GroupByCallback<TContext> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupBy(component, callback);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> GroupBy<T, TContext>(Ecs.GroupByCallback<TContext> callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> GroupByCtx<T>(T value)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> GroupByCtx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="Core.QueryBuilder.GroupByCtx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> GroupByCtx<T>(T value, delegate*<ref T, void> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupByCtx(value, callback);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> OnGroupCreate(Ecs.GroupCreateCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> OnGroupCreate<T>(Ecs.GroupCreateCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupCreate(callback);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> OnGroupDelete(Ecs.GroupDeleteCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> OnGroupDelete<T>(Ecs.GroupDeleteCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupDelete(callback);
        return ref this;
    }
