// /_/src/Flecs.NET/Generated/QueryBuilder/QueryBuilder.QueryBuilder/T6.g.cs
...
public unsafe partial struct QueryBuilder<T0, T1, T2, T3, T4, T5>
{
    /// <inheritdoc cref="Core.QueryBuilder.Self()"/>
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Self()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Id(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Entity(ulong entity)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Name(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Var(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Term(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Src()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> First()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Second()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Src(ulong srcId)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Src<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Src<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Src(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> First(ulong firstId)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> First<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> First<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> First(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Second(ulong secondId)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Second<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Second<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Second(string secondName)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Up(ulong traverse = 0)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Up<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Up<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Cascade(ulong traverse = 0)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Cascade<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Cascade<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Descend()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Parent()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Trav(ulong traverse, uint flags = 0)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Trav<T>(uint flags = 0)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Trav<T>(T value, uint flags = 0) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Flags(ulong flags)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> InOut(ecs_inout_kind_t inOut)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> InOutStage(ecs_inout_kind_t inOut)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Write()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Read()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> ReadWrite()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> In()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Out()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> InOut()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> InOutNone()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Oper(ecs_oper_kind_t oper)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> And()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Or()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Not()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Optional()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> AndFrom()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> OrFrom()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> NotFrom()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Singleton()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Filter()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> QueryFlags(uint flags)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> CacheKind(ecs_query_cache_kind_t kind)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Cached()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> DetectChanges()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Expr(string expr)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> With(Term term)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> With(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> With(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> With(ulong first, ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> With(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> With(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> With(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> With<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> With<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> With<TFirst>(ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> With<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).With<TFirst>(second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> With<TFirst, TSecond>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> With<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> With<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> With<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> With<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> WithSecond<TSecond>(ulong first)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> WithSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WithSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Without(Term term)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Without(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Without(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Without(ulong first, ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Without(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Without(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Without(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Without<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Without<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Without<TFirst>(ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Without<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Without<TFirst>(second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Without<TFirst, TSecond>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Without<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Without<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Without<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Without<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> WithoutSecond<TSecond>(ulong first)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> WithoutSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WithoutSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Write(Term term)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Write(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Write(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Write(ulong first, ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Write(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Write(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Write(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Write<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Write<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Write<TFirst>(ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Write<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Write<TFirst>(second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Write<TFirst, TSecond>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Write<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Write<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Write<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Write<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> WriteSecond<TSecond>(ulong first)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> WriteSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WriteSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Read(Term term)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Read(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Read(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Read(ulong first, ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Read(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Read(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Read(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Read<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Read<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Read<TFirst>(ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Read<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Read<TFirst>(second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Read<TFirst, TSecond>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Read<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Read<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Read<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Read<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> ReadSecond<TSecond>(ulong first)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> ReadSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).ReadSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> ScopeOpen()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> ScopeClose()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> Term()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> TermAt<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> TermAt(int termIndex)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> TermAt<T>(int termIndex)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> OrderBy(ulong component, Ecs.OrderByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> OrderBy<T>(Ecs.OrderByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> GroupBy(ulong component)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> GroupBy(ulong component, Ecs.GroupByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> GroupBy<TContext>(ulong component, Ecs.GroupByCallback<TContext> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupBy(component, callback);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> GroupBy<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> GroupBy<T>(Ecs.GroupByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> GroupBy<T, TContext>(Ecs.GroupByCallback<TContext> callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> GroupByCtx<T>(T value)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> GroupByCtx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="Core.QueryBuilder.GroupByCtx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> GroupByCtx<T>(T value, delegate*<ref T, void> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupByCtx(value, callback);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> OnGroupCreate(Ecs.GroupCreateCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> OnGroupCreate<T>(Ecs.GroupCreateCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupCreate(callback);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> OnGroupDelete(Ecs.GroupDeleteCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5> OnGroupDelete<T>(Ecs.GroupDeleteCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupDelete(callback);
        return ref this;
    }
