// /_/src/Flecs.NET/Generated/QueryBuilder/QueryBuilder.QueryBuilder/T8.g.cs
...
public unsafe partial struct QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7>
{
    /// <inheritdoc cref="Core.QueryBuilder.Self()"/>
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Self()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Id(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Entity(ulong entity)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Name(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Var(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Term(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Src()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> First()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Second()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Src(ulong srcId)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Src<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Src<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Src(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> First(ulong firstId)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> First<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> First<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> First(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Second(ulong secondId)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Second<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Second<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Second(string secondName)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Up(ulong traverse = 0)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Up<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Up<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Cascade(ulong traverse = 0)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Cascade<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Cascade<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Descend()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Parent()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Trav(ulong traverse, uint flags = 0)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Trav<T>(uint flags = 0)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Trav<T>(T value, uint flags = 0) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Flags(ulong flags)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> InOut(ecs_inout_kind_t inOut)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> InOutStage(ecs_inout_kind_t inOut)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Write()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Read()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> ReadWrite()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> In()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Out()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> InOut()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> InOutNone()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Oper(ecs_oper_kind_t oper)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> And()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Or()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Not()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Optional()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> AndFrom()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> OrFrom()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> NotFrom()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Singleton()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Filter()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> QueryFlags(uint flags)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> CacheKind(ecs_query_cache_kind_t kind)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Cached()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> DetectChanges()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Expr(string expr)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> With(Term term)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> With(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> With(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> With(ulong first, ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> With(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> With(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> With(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> With<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> With<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> With<TFirst>(ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> With<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).With<TFirst>(second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> With<TFirst, TSecond>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> With<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> With<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> With<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> With<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).With(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> WithSecond<TSecond>(ulong first)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> WithSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WithSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Without(Term term)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Without(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Without(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Without(ulong first, ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Without(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Without(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Without(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Without<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Without<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Without<TFirst>(ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Without<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Without<TFirst>(second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Without<TFirst, TSecond>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Without<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Without<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Without<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Without<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Without(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> WithoutSecond<TSecond>(ulong first)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> WithoutSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WithoutSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Write(Term term)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Write(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Write(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Write(ulong first, ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Write(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Write(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Write(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Write<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Write<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Write<TFirst>(ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Write<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Write<TFirst>(second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Write<TFirst, TSecond>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Write<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Write<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Write<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Write<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Write(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> WriteSecond<TSecond>(ulong first)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> WriteSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).WriteSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Read(Term term)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Read(ulong id)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Read(string name)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Read(ulong first, ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Read(ulong first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Read(string first, ulong second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Read(string first, string second)
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Read<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Read<T>(T value) where T : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Read<TFirst>(ulong second)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Read<TFirst>(string second)
    {
        Ecs.GetQueryBuilder(ref this).Read<TFirst>(second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Read<TFirst, TSecond>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Read<TFirst, TSecond>(TSecond second) where TSecond : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Read<TFirst, TSecond>(TFirst first) where TFirst : Enum
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Read<TFirst>(TFirst first, string second) where TFirst : Enum
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Read<TSecond>(string first, TSecond second) where TSecond : Enum
    {
        Ecs.GetQueryBuilder(ref this).Read(first, second);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> ReadSecond<TSecond>(ulong first)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> ReadSecond<TSecond>(string first)
    {
        Ecs.GetQueryBuilder(ref this).ReadSecond<TSecond>(first);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> ScopeOpen()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> ScopeClose()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> Term()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> TermAt<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> TermAt(int termIndex)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> TermAt<T>(int termIndex)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> OrderBy(ulong component, Ecs.OrderByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> OrderBy<T>(Ecs.OrderByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> GroupBy(ulong component)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> GroupBy(ulong component, Ecs.GroupByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> GroupBy<TContext>(ulong component, Ecs.GroupByCallback<TContext> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupBy(component, callback);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> GroupBy<T>()
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> GroupBy<T>(Ecs.GroupByCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> GroupBy<T, TContext>(Ecs.GroupByCallback<TContext> callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> GroupByCtx<T>(T value)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> GroupByCtx<T>(T value, Ecs.UserContextFinish<T> callback)
    {
    ...
    /// <inheritdoc cref="Core.QueryBuilder.GroupByCtx{T}(T, Ecs.UserContextFinish{T})"/>
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> GroupByCtx<T>(T value, delegate*<ref T, void> callback)
    {
        Ecs.GetQueryBuilder(ref this).GroupByCtx(value, callback);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> OnGroupCreate(Ecs.GroupCreateCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> OnGroupCreate<T>(Ecs.GroupCreateCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupCreate(callback);
        return ref this;
    }
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> OnGroupDelete(Ecs.GroupDeleteCallback callback)
    {
    ...
    public ref QueryBuilder<T0, T1, T2, T3, T4, T5, T6, T7> OnGroupDelete<T>(Ecs.GroupDeleteCallback<T> callback)
    {
        Ecs.GetQueryBuilder(ref this).OnGroupDelete(callback);
        return ref this;
    }
